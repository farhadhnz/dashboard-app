...
import { CharErrorCode, ChartSelectEvent, ChartErrorEvent } from '../Interfaces/chart-events';
import type { CountriesData, SelectionExtra, DrawableCountries, Selection,
  ValidExtraData, DrawableCountry, CountryData } from '../Interfaces/chart-data-types';
import { en as countriesEN } from '@jagomf/countrieslist';
// import { scale } from 'chroma-js';

const exists = (item: number | null) => typeof item !== 'undefined' && item !== null;
...
export class FarhadMapComponent implements AfterViewInit, OnChanges {

  @Input() data: CountriesData | null;
  ...
  @ViewChild('mapContent', { static: false, read: ElementRef }) private readonly mapContent: ElementRef<HTMLElement> | undefined;

  mapData: DrawableCountries | undefined;
  ...
  //         (acc, curr) => countryNum(curr) > acc || acc === null? countryNum(curr) : acc, null as unknown as number
  //       );
